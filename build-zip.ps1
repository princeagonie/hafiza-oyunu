# =====================================================================
#  Yukleme paketi uretir (portallar, arsiv, yedek).
#
#  Oyun TAMAMEN REKLAMSIZ. Reklam SDK'si, ads.js ve ilgili kodlarin
#  tamami kaldirildi.
#
#  IKI TUZAGI ASAR:
#
#  1) Compress-Archive KULLANILMIYOR. PowerShell 5.1 zip yollarini
#     ters boluyle yaziyor (assets\x.jpg); sunucu tarafindaki aciciler
#     bunu klasor saymayip tek dosya adi saniyor ve dosyalar 404
#     donuyordu. Burada her girdinin adini duz boluyle biz veriyoruz.
#
#  2) KOD DOSYALARI SURUMLENIYOR (game.js -> game.2609151030.js gibi).
#     Bazi CDN'ler dosyalari ayri ayri onbellege aliyor; yeni
#     index.html ile ESKI game.js eslesince oyun bozuluyordu. Her
#     paket yeni dosya adlari tasidigi icin bu olamaz.
#
#  Kullanim:
#    powershell -ExecutionPolicy Bypass -File build-zip.ps1
#    powershell -ExecutionPolicy Bypass -File build-zip.ps1 -Label gameflare
# =====================================================================
param(
